...
Function Notification(String msg) Global
    Debug.Notification("[BeeingFemaleNG] " + msg)
	WriteLog(msg)
EndFunction

Function MessageBox(String msg) Global
    Debug.MessageBox("[BeeingFemaleNG] " + msg)
	WriteLog(msg)
EndFunction

Function PrintConsole(String msg) Global
    MiscUtil.PrintConsole("[BeeingFemaleNG] " + msg)
EndFunction
