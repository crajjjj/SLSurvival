...
Function CreateDDZapArmbDoggy01(int id)
	...
	if Anim != none && Anim.Name != "DDZapArmbDoggy01"
		...
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S1", -100, strapon = true, sos = 5)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S2", -100, strapon = true, sos = 5)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S3", -100, strapon = true, sos = 7)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S4", -100, strapon = true, sos = 5)
...
Function CreateDDZapArmbMissionary01(int id)
	...
	if Anim != none && Anim.Name != "DDZapArmbMissionary01"
		...
		Int a2 = Anim.AddPosition(Male)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S1", -86, strapon = true, sos = 4)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S2", -86, strapon = true, sos = 4)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S3", -86, strapon = true, sos = 3)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S4", -86, strapon = true, sos = 3)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S4", -86, strapon = true, sos = 3)
...
Function CreateDDZapYokeMissionary02(int id)
	...
	if Anim != none && Anim.Name != "DDZapYokeMissionary02"
		...
		int a2 = Anim.AddPosition(Male)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S1", -105, strapon = true)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S2", -105, strapon = true)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S3", -105, strapon = true, sos = 3)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S4", -105, strapon = true, sos = 7)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S5", -105, strapon = true, sos = 7)
...
Function CreateDDZapYokeMissionary03(int id)
	...
	if Anim != none && Anim.Name != "DDZapYokeMissionary03"
		...
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S2", -105, strapon = true)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S3", -105, strapon = true, sos = 3)
		Anim.AddPositionStage(a2, asAnim2 + "_A2_S4", -107, strapon = true, sos = 7)
...
Function CreateDD_B_PS_DT(int id)	
	...
	if Anim != none && Anim.Name != "DD_B_PS_DT"
		...
		Int a1 = Anim.AddPosition(Female, addCum = Oral)
		Anim.AddPositionStage(a1, asAnim1 + "_A1_S1", 0.0, silent = True, openMouth = True)
		Anim.AddPositionStage(a1, asAnim1 + "_A1_S2", 0.0, silent = True, openMouth = True)
		Anim.AddPositionStage(a1, asAnim1 + "_A1_S3", 0.0, silent = True, openMouth = True)
		Anim.AddPositionStage(a1, asAnim1 + "_A1_S4", 0.0, silent = True, openMouth = True)
		Anim.AddPositionStage(a1, asAnim1 + "_A1_S4", 0.0, silent = True, openMouth = True)
