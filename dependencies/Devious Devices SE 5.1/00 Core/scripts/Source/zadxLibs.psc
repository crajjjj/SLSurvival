...
Function RegisterEvents()
	libs.log("DDX Events registered")
	RegisterForModEvent("DDI_RegisterDevices", "OnRegisterDevices")
EndFunction

Event OnRegisterDevices(string eventName, string strArg, float numArg, Form sender)	
	libs.log("DDX RegisterDevices event received.")
	RegisterDevices()	
EndEvent
...
Function RegisterDevices()
	...
	libs.log("Registering DDX Devices at user request")
	...
	;straitjackets
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsBlackInventory		, "straitjacket,legbinder,blocking,hobble,leather,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsRedInventory			, "straitjacket,legbinder,blocking,hobble,leather,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsWhiteInventory		, "straitjacket,legbinder,blocking,hobble,leather,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexLegsBlackInventory			, "straitjacket,legbinder,blocking,hobble,latex,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexLegsRedInventory			, "straitjacket,legbinder,blocking,hobble,latex,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexLegsWhiteInventory			, "straitjacket,legbinder,blocking,hobble,latex,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherBlackInventory			, "straitjacket,jacket,blocking,hobble,leather,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherRedInventory				, "straitjacket,jacket,blocking,hobble,leather,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherWhiteInventory			, "straitjacket,jacket,blocking,hobble,leather,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexBlackInventory				, "straitjacket,jacket,blocking,hobble,latex,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexRedInventory				, "straitjacket,jacket,blocking,hobble,latex,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketlatexWhiteInventory				, "straitjacket,jacket,blocking,hobble,latex,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsToplessBlackInventory		, "straitjacket,legbinder,blocking,hobble,leather,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsToplessRedInventory			, "straitjacket,legbinder,blocking,hobble,leather,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherLegsToplessWhiteInventory		, "straitjacket,legbinder,blocking,hobble,leather,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexLegsToplessBlackInventory			, "straitjacket,legbinder,blocking,hobble,latex,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexLegsToplessRedInventory			, "straitjacket,legbinder,blocking,hobble,latex,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexLegsToplessWhiteInventory			, "straitjacket,legbinder,blocking,hobble,latex,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherToplessBlackInventory			, "straitjacket,jacket,blocking,hobble,leather,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherToplessRedInventory				, "straitjacket,jacket,blocking,hobble,leather,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLeatherToplessWhiteInventory			, "straitjacket,jacket,blocking,hobble,leather,white,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexToplessBlackInventory				, "straitjacket,jacket,blocking,hobble,latex,black,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexToplessRedInventory				, "straitjacket,jacket,blocking,hobble,latex,red,pincopallino,ddx")
	libs.RegisterGenericDevice(zadx_StraitJacketLatexToplessWhiteInventory				, "straitjacket,jacket,blocking,hobble,latex,white,pincopallino,ddx")	
