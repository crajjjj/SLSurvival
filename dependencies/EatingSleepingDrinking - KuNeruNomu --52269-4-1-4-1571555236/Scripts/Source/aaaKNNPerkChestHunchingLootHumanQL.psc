Scriptname aaaKNNPerkChestHunchingLootHumanQL extends activemagiceffect
...
Function RegisterAnimEvent(Actor akTarget)
	;Debug.Trace("aaaKNNPerkChestHunchingLootHumanQL")
...
Event OnAnimationEvent(ObjectReference akSource, string asEventName)
	...
	elseIf asEventName == "KNNOpenChestHunchingQLLootFinished"
		...
		endIf
		GoToState("AnimControl")
	elseIf asEventName == "JumpDown" || asEventName == hunchingLootInsEnd_Done
		;Debug.Notification("OnAnimationEvent : " + asEventName)
		GoToState("")
		IsAnimFinished = true
		self.Dispel()
