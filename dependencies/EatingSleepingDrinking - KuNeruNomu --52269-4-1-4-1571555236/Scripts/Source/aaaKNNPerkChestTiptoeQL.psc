Scriptname aaaKNNPerkChestTiptoeQL extends activemagiceffect
...
Function RegisterAnimEvent(Actor akTarget)
	...
	RegisterForAnimationEvent(akTarget, "KNNOpenChestTiptoeQLStartFinished")
	if (animCtrl as aaaKNNAnimControlQuest).GetGender(akTarget)
		tipToeStart = "KNNOpenChestTiptoeQLStart"
		tipToeStartIns = "KNNOpenChestTiptoeQLInstantStart"
		tipToeEnd = "KNNOpenChestTiptoeQLEnd"

		tipToeEnd_Done = "KNNOpenChestTiptoeQLEnd_DONE"
		tipToeLootInsEnd_Done = "KNNOpenChestTiptoeQLInstantEnd_DONE"
	else
		tipToeStart = "KNNOpenChestTiptoeQLStart_M"
		tipToeStartIns = "KNNOpenChestTiptoeQLInstantStart_M"
		tipToeEnd = "KNNOpenChestTiptoeQLEnd_M"

		tipToeEnd_Done = "KNNOpenChestTiptoeQLEnd_M_DONE"
		tipToeLootInsEnd_Done = "KNNOpenChestTiptoeQLInstantEnd_M_DONE"
	endIf
...
Event OnAnimationEvent(ObjectReference akSource, string asEventName)
	if GetTargetActor() != akSource
		return
	endIf
	if asEventName == "KNNOpenChestTiptoeQLStartFinished"
