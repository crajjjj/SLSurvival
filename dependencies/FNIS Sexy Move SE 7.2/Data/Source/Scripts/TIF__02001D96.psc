...
Scriptname TIF__02001D96 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
int i = 1 - akSpeaker.GetItemCount(FNISSMCoin)
if i > 0
	akSpeaker.AddItem(FNISSMCoin,i,true)
elseif i < 0
	akSpeaker.RemoveItem(FNISSMCoin,-i,true)
endif
;akSpeaker.SetAnimationVariableInt("FNISvaa1",1)	
bool bOk = FNIS_aa.SetAnimGroup(akSpeaker, "_mt", FNISSMQuest.FNISsmMtBase, 0, "FNIS Sexy Move", true)		; animvar 1 less than coins
