...
Scriptname TIF__02004350 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
int i = 6 - akSpeaker.GetItemCount(FNISSMCoin)
if i > 0
	akSpeaker.AddItem(FNISSMCoin,i,true)
elseif i < 0
	akSpeaker.RemoveItem(FNISSMCoin,-i,true)
endif
;akSpeaker.SetAnimationVariableInt("FNISvaa1",6)	
bool bOk = FNIS_aa.SetAnimGroup(akSpeaker, "_mt", FNISSMQuest.FNISsmMtBase, 5, "FNIS Sexy Move", true)
