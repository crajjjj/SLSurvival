Scriptname RND_DrinkFromWaterSourceScript extends activemagiceffect  
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
	...
	if RND_Player.isVampire()	
		...
		bool isSeawater = false
	
		if RND_Player.isInSeawater()
			isSeawater = True
			RND_SeawaterMessage.Show()
		else
			; drink water
		...
		; CoughCough
		if isSeawater || Utility.RandomInt(0,100) <= 10
...
Message Property RND_SeawaterMessage Auto
