...
; Expressive Types
int property ExpressionsDisabled = -1 autoreadonly hidden
int property ExpressionsAllowAny = 0 autoreadonly hidden
int property ExpressionsForceNormal = 1 autoreadonly hidden
int property ExpressionsForceAhegao = 2 autoreadonly hidden
; Content Types
...
sslBaseAnimation function RegisterJSON(string Filename)
	...
	endIf
	float[] FurnitureOffset = JsonUtil.PathFloatElements(Filename, ".furnitureoffset")
	if FurnitureOffset && FurnitureOffset.Length == 4
		Slot.SetFurnitureOffsets(FurnitureOffset[0], FurnitureOffset[1], FurnitureOffset[2], FurnitureOffset[3])
	endIf
