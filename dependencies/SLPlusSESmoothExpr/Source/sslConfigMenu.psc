...
function SystemCheckOptions()
	AddTextOption("Skyrim Script Extender (2.0.17+)", StringIfElse(Config.CheckSystemPart("SKSE"), "<font color='#00FF00'>ok</font>", "<font color='#FF0000'>X</font>")) ;SSE
	AddTextOption("SexLabUtil.dll SKSE Plugin  (1.63+)", StringIfElse(Config.CheckSystemPart("SexLabUtil"), "<font color='#00FF00'>ok</font>", "<font color='#FF0000'>X</font>"))	;SSE
	AddTextOption("PapyrusUtil.dll SKSE Plugin  (3.9+)", StringIfElse(Config.CheckSystemPart("PapyrusUtil"), "<font color='#00FF00'>ok</font>", "<font color='#FF0000'>X</font>")) ;SSE
