...
string[] Function GetMenuEntries(Form akForm)
	...
	entries[1] = "$EFF_Default" + ";;" + GetIdentifier() + ";;" + (itemOffset + 0) + ";;" + 0 + ";;0"
	entries[2] = "$EFF_Archer" + ";;" + GetIdentifier() + ";;" + (itemOffset + 1) + ";;" + 1 + ";;0"
	entries[3] = "$EFF_Berserker" + ";;" + GetIdentifier() + ";;" + (itemOffset + 2) + ";;" + 2 + ";;0"
	entries[4] = "$EFF_Mage" + ";;" + GetIdentifier() + ";;" + (itemOffset + 3) + ";;" + 3 + ";;0"
	entries[5] = "$EFF_Thief" + ";;" + GetIdentifier() + ";;" + (itemOffset + 4) + ";;" + 4 + ";;0"
	entries[6] = "$EFF_Warrior" + ";;" + GetIdentifier() + ";;" + (itemOffset + 5) + ";;" + 5 + ";;0"
	return entries
EndFunction
