...
string[] Function GetMenuEntries(Form akForm)
	...
	entries[1] = "$EFF_Teach" + ";;" + GetIdentifier() + ";;" + (itemOffset + 0) + ";;" + 0 + ";;1"
	entries[2] = "$EFF_Left_Hand" + ";;" + (itemOffset + 0) + ";;" + (itemOffset + 10) + ";;" + 0 + ";;0"
	entries[3] = "$EFF_Right_Hand" + ";;" + (itemOffset + 0) + ";;" + (itemOffset + 11) + ";;" + 1 + ";;0"

	entries[4] = "$EFF_Forget" + ";;" + GetIdentifier() + ";;" + (itemOffset + 1) + ";;" + 0 + ";;1"
	entries[5] = "$EFF_Left_Hand" + ";;" + (itemOffset + 1) + ";;" + (itemOffset + 20) + ";;" + 0 + ";;0"
	entries[6] = "$EFF_Right_Hand" + ";;" + (itemOffset + 1) + ";;" + (itemOffset + 21) + ";;" + 1 + ";;0"
