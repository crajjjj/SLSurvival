...
Scriptname SLV_ArenaSlut9 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
SLV_WaitingVisitor1.clear()
Game.getplayer().removeItem(FoodRabbitCooked ,1)
...
ReferenceAlias Property SLV_WaitingVisitor1 Auto
