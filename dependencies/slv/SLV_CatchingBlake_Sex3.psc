...
Scriptname SLV_CatchingBlake_Sex3 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
if myScripts.SLV_CheckforSexAnimation("FunnyBizness Nympho MMMMF")
	actor[] sexActors = new actor[5]
	sexActors[0] = Game.GetPlayer()
	sexActors[1] = SLV_Zaid.getActorRef()
	sexActors[2] = SLV_Amren.getActorRef()
	sexActors[3] = SLV_JarlWhiterun.getActorRef()
	sexActors[4] = SLV_Brutus.getActorRef()

	myScripts.SLV_PlaySexAnimationSynchron(sexActors,"FunnyBizness Nympho MMMMF","Sex", true)
else
	myScripts.SLV_PlaySex2Synchron(Game.getPlayer(),  SLV_Brutus.getActorRef(), "Sex", true)
endif
