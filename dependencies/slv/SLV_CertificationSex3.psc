...
Scriptname SLV_CertificationSex3 Extends TopicInfo Hidden
...
myScripts.SLV_PlaySex3Synchron(SLV_Ivana.getActorRef() ,akSpeaker, SLV_Belethor.getActorRef(), "FMM", false)
