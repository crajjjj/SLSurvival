...
Scriptname SLV_ColloseumArchitect Extends Quest Hidden

;BEGIN ALIAS PROPERTY SLV_Jarl
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_Jarl Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY SLV_BuildingAreaMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_BuildingAreaMarker Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY SLV_MinerSlave2
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_MinerSlave2 Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY SLV_SexSlaveVol47
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_SexSlaveVol47 Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY SLV_MinerSlave1
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_MinerSlave1 Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY SLV_Leigelf
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_Leigelf Auto
;END ALIAS PROPERTY
...
ActorUtil.ClearPackageOverride(Alias_SLV_Leonardo.getActorRef())
Alias_SLV_Leonardo.getActorRef().evaluatePackage()
;Alias_SLV_Leonardo

ActorUtil.ClearPackageOverride(Alias_SLV_Michelangela.getActorRef())
Alias_SLV_Michelangela.getActorRef().evaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
SLV_HouseScript Property housescript auto
