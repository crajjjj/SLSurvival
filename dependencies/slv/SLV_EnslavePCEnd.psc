...
Scriptname SLV_EnslavePCEnd Extends TopicInfo Hidden
...
myScripts.SLV_DeviousUnEquipActor2(Game.GetPlayer(),true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true, true, true, true, true, true, true)

myScripts.SLV_DeviousEquipActor2(Game.GetPlayer(),false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false, false, false, false, false, false, false)
