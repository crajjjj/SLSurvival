...
Scriptname SLV_GladiatorMerlin Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY SLV_Merlin
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SLV_Merlin Auto
;END ALIAS PROPERTY
...
Function Fragment_5()
;BEGIN CODE
ALIAS_SLV_Merlin.getActorRef().enable()
