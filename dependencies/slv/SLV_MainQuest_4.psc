...
Scriptname SLV_MainQuest_4 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
if GetOwningQuest().getStage() == 4400
	GetOwningQuest().SetObjectiveCompleted(4400)
	GetOwningQuest().SetStage(4450)
endif
...
SLV_SlaveryEnforcementQuest.SetObjectiveCompleted(5000)
SLV_SlaveryEnforcementQuest.SetStage(5500)
