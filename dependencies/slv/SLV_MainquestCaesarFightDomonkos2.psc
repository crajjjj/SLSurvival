...
Scriptname SLV_MainquestCaesarFightDomonkos2 Extends TopicInfo Hidden
...
SLV_Fighter1.ForceRefTo(SLV_Artus )
SLV_Artus.removefromFaction( SLV_ColosseumNPCLost )
...
SLV_ColosseumGladiator.setValue(102)
