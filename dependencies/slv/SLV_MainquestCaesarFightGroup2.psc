...
Scriptname SLV_MainquestCaesarFightGroup2 Extends TopicInfo Hidden
...
if SLV_ArenaGladiatorQuest.getstage() >= 3000
...
SLV_ColosseumGladiatorsNumber.setValue(3)
;END CODE
EndFunction
;END FRAGMENT
