...
Scriptname SLV_MainquestCaesarFightMerlin Extends TopicInfo Hidden
...
SLV_Fighter1.ForceRefTo(SLV_Conan)
SLV_Fighter2.Clear()
SLV_Fighter3.Clear()
SLV_Fighter4.Clear()
...
SLV_ColosseumGladiator.setValue(802)
