...
Scriptname SLV_MainquestCaesarFightTwoTails2 Extends TopicInfo Hidden
...
SLV_Fighter1.ForceRefTo(SLV_TwoTails)

SLV_Fighter2.clear()
SLV_Fighter3.clear()
SLV_Fighter4.clear()

SLV_ColosseumGladiator.setValue(4)
...
Actor Property SLV_TwoTails Auto
