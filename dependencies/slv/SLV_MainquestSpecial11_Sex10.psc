...
Scriptname SLV_MainquestSpecial11_Sex10 Extends TopicInfo Hidden
...
sexActors[1] = SLV_CarriageDriver.getActorRef()
sexActors[2] = SLV_Tourist1.getActorRef()
sexActors[3] = SLV_Tourist2.getActorRef()
sexActors[4] = SLV_Tourist3.getActorRef()
