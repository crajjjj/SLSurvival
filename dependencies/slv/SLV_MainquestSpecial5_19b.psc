...
Scriptname SLV_MainquestSpecial5_19b Extends TopicInfo Hidden
...
myScripts.SLV_Play3Sex( Game.GetPlayer(),SexTourist3a.getActorRef(), SexTourist3b.getActorRef() ,"Anal", false)
