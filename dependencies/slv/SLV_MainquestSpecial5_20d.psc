...
Scriptname SLV_MainquestSpecial5_20d Extends TopicInfo Hidden
...
myScripts.SLV_Play3Sex(SexSlave.getActorRef(),SexTourist1a.getActorRef(), SexTourist1a.getActorRef(),"Vaginal", true)
;END CODE
EndFunction
;END FRAGMENT
