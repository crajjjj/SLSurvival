...
Scriptname SLV_MainquestSpecial5_7b Extends TopicInfo Hidden
...
myScripts.SLV_Play3Sex(SLV_SlaveFollower.getActorRef(),akSpeaker, SexTourist2b.getActorRef() ,"FMM", true)
;END CODE
EndFunction
;END FRAGMENT
