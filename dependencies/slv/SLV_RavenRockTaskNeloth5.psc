...
Scriptname SLV_RavenRockTaskNeloth5 Extends TopicInfo Hidden
...
SLV_SlaveFollower.ForceRefTo(Game.GetPlayer())
SLV_SlaveFollowerMain.ForceRefTo(Game.GetPlayer())
