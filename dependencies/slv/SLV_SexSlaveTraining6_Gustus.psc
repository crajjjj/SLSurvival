Scriptname SLV_SexSlaveTraining6_Gustus extends ReferenceAlias  
...
if SLV_SexSlaveTraining6Quest.getStage() == 3000
	SLV_SexSlaveTraining6Quest.SetObjectiveCompleted(3000)
	SLV_SexSlaveTraining6Quest.SetStage(3500)
EndIf
EndFunction
