...
Scriptname SLV_SlaveCertification3_Sex7 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
myScripts.SLV_Play2SexAnimation(Game.GetPlayer(),SLV_JarlWhiterun.getActorRef(),"Leito Blowjob", "Blowjob", true)
Utility.wait(10)

actor[] sexActors = new actor[3]
sexActors[0] = SLV_Eva.getActorRef()
