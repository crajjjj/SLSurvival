...
Scriptname SLV_SlaveCertification4_Sex7 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
myScripts.SLV_PlaySex3Synchron(SLV_Diamond.getActorRef(), SLV_Amren.getActorRef(),SLV_Nazeem.getActorRef(), "MMF", true)
