...
Scriptname SLV_SolitudeFashion10 Extends TopicInfo Hidden
...
myScripts.SLV_DeviousEquipActorColor(Game.GetPlayer(),",black", "",true,true,false,true,true,true,true,false,true,true,true,true,true,true,true)
