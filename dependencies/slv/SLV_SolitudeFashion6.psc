...
Scriptname SLV_SolitudeFashion6 Extends TopicInfo Hidden
...
myScripts.SLV_DeviousEquipActorColor(Game.GetPlayer(),",black","",false,false,false,false,false,true,true,false,false,false,false,false,true,false,true)
;Utility.wait(2.0)
