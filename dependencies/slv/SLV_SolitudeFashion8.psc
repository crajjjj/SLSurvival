...
Scriptname SLV_SolitudeFashion8 Extends TopicInfo Hidden
...
;Utility.wait(2.0)
myScripts.SLV_DeviousEquipActorColor(Game.GetPlayer(),",black","",false,false,true,false,false,false,true,false,false,false,false,false,true,true,false)
;Utility.wait(2.0)
