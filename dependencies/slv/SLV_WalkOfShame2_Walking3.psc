...
Scriptname SLV_WalkOfShame2_Walking3 Extends Scene Hidden
...
Function Fragment_0()
;BEGIN CODE
SLV_Horse1.getActorRef().moveto(horsestop)
SLV_Horse1.getActorRef().disable()

SLV_Horse2.getActorRef().moveto(horsestop)
...
SLV_Horse2.getActorRef().enable()
SLV_Horse2.getActorRef().moveto(horsestart)
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property horsestop Auto
