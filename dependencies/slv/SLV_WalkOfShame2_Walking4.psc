...
Scriptname SLV_WalkOfShame2_Walking4 Extends Scene Hidden
...
;BEGIN CODE
debug.SendAnimationEvent(SLV_Bellamy.getActorRef(), "IdleForceDefaultState")
debug.SendAnimationEvent(SLV_Murphy.getActorRef(), "IdleForceDefaultState")
debug.SendAnimationEvent(SLV_Pike.getActorRef(), "IdleForceDefaultState")
debug.SendAnimationEvent(SLV_Eric.getActorRef(), "IdleForceDefaultState")
debug.SendAnimationEvent(SLV_Watcher1.getActorRef(), "IdleForceDefaultState")
debug.SendAnimationEvent(SLV_Watcher2.getActorRef(), "IdleForceDefaultState")
;END CODE
EndFunction
;END FRAGMENT
...
myScripts.SLV_DisplayInformation("Spectator1: " + SLV_Spectator1)
myScripts.SLV_DisplayInformation("Spectator1: " + SLV_Spectator1.getActorRef())
myScripts.SLV_DisplayInformation("Spectator1: " + SLV_Spectator1.getActorRef().getActorBase())
