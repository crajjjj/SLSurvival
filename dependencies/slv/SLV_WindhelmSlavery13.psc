...
Scriptname SLV_WindhelmSlavery13 Extends TopicInfo Hidden
...
myScripts.SLV_DeviousEquip(true,true,false,true,true,true,true,false,false,true,true,true,true,true,true)
