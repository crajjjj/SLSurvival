...
New to the mod? Read [Getting Started](players/getting-started.md) — requirements, load order, the FOMOD options, and "it doesn't show up in the MCM" fixes.
...
[Internals](internals.md) — for anyone reading the source: the plugin and BSA layout, the adapter pattern that lets SLS survive missing mods, the Papyrus gotchas, and how to build.
